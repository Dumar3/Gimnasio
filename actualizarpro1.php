...
<body>     
    ...
    ?>
        <form action="actualizarprof2.php" method="post">
    ...
    <?php
        ...
        echo "No existe un profesor registrado con esta cedula";
    ?>
        </b></font>
        <form action="actualizarProfesor.php" method="post">         
        <a href='http://localhost/Gimnasio/actualizarProfesor.php' type="submit"> 
